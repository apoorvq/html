                ...
                <div class="clearfix">
                    ...
                    <div class="slide-column col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="news-block-three style-two">
                            <div class="inner-box">
                                <div class="image">
                                    <img height="505px" class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="<?php echo $news['sources'][$j]; ?>" alt="" />
                                    <div class="overlay-box">
                                        <div class="content">
                                            <div class="tag"><a href="categories.php?category=<?php echo $news['categoriesName'][$j]; ?>"><?php echo $news['categoriesName'][$j]; ?></a></div>
                                            <h3><a href="singlenews.php?news=<?php echo $news['slugs'][$j]; ?>"><?php echo $news['headlines'][$j]; ?></a></h3>
                                            <ul class="post-meta">
                                                <li><span class="icon qb-clock"></span><?php echo $news['cardDate'][$j]; ?></li>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row clearfix">
                             <div class="inner-slide col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="news-block-three style-four">
                                    <div class="inner-box">
                                        <div class="image">
                                            <img height="250px" class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="<?php echo $news['sources'][$j+1]; ?>" alt="" />
                                            <div class="overlay-box">
                                                <div class="content">
                                                    <div class="tag"><a  href="categories.php?category=<?php echo $news['categoriesName'][$j+1]; ?>""><?php echo $news['campaignName'][$i]; ?></a></div>
                                                    <h3><a href="singlenews.php?news=<?php echo $news['slugs'][$j+1]; ?>"><?php echo $news['headlines'][$j+1]; ?></a></h3>
                                                    <ul class="post-meta">
                                                        <li><span class="icon qb-clock"></span><?php echo $news['cardDate'][$i
                                                            +1]; ?></li>
                                                    </ul>
                                                </div>
                                            </div>
                            ...
                            <div class="inner-slide col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="news-block-three style-four">
                                    <div class="inner-box">
                                        <div class="image">
                                            <img height="250px" class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="<?php echo $news['sources'][$j+2]; ?>" alt="" />
                                            <div class="overlay-box">
                                                <div class="content">
                                                    <div class="tag"><a  href="categories.php?category=<?php echo $news['categoriesName'][$j+2]; ?>"><?php echo $news['campaignName'][$j+2]; ?></a></div>
                                                    <h3><a href="singlenews.php?news=<?php echo $news['slugs'][$j+2]; ?>"><?php echo $news['headlines'][$j+2]; ?></a></h3>
                                                    <ul class="post-meta">
                                                        <li><span class="icon qb-clock"></span><?php echo $news['cardDate'][$i
                                                            +2]; ?></li>
                                                    </ul>
                            ...
                            <div class="inner-slide col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="news-block-three style-four">
                                    <div class="inner-box">
                                        <div class="image">
                                            <img height="250px" class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="<?php echo $news['sources'][$j+3]; ?>" alt="" />
                                            <div class="overlay-box">
                                                <div class="content">
                                                    <div class="tag"><a href="categories.php?category=<?php echo $news['categoriesName'][$j+3]; ?>"><?php echo $news['campaignName'][$j+3]; ?></a></div>
                                                    <h3><a href="singlenews.php?news=<?php echo $news['slugs'][$j+3]; ?>"><?php echo $news['headlines'][$j+3]; ?></a></h3>
                                                    <ul class="post-meta">
                                                        <li><span class="icon qb-clock"></span><?php echo $news['cardDate'][$i
                                                            +3]; ?></li>
                                                    </ul>
                            ...
                            <div class="inner-slide col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="news-block-three style-four">
                                    <div class="inner-box">
                                        <div class="image">
                                            <img height="250px" class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="<?php echo $news['sources'][$j+4]; ?>" alt=""  />
                                            <div class="overlay-box">
                                                <div class="content">
                                                    <div class="tag"><a  href="categories.php?category=<?php echo $news['categoriesName'][$j+4]; ?>"><?php echo $news['campaignName'][$j+4]; ?></a></div>
                                                    <h3><a href="singlenews.php?news=<?php echo $news['slugs'][$j+4]; ?>"><?php echo $news['headlines'][$j+4]; ?></a></h3>
                                                    <ul class="post-meta">
                                                        <li><span class="icon qb-clock"></span><?php echo $news['cardDate'][$i
                                                            +4]; ?></li>
                                                    </ul>
                        ...
                        <?php for ($i=15; $i < 21; $i++) { ?>
                            <div class="column col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="news-block-two with-margin">
                                    <div class="inner-box">
                                        <div class="image">
                                            <a href="singlenews.php?news=<?php echo $news['slugs'][$i]; ?>"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="<?php echo $news['sources'][$i]; ?>" alt="" /></a>
                                            <div class="category"><a href="categories.php?category=<?php echo $news['categoriesName'][$i]; ?>"><?php echo $news['categoriesName'][$i]; ?></a></div>
                                        </div>
                                        <div class="lower-box">
                                            <h3><a href="singlenews.php?news=<?php echo $news['slugs'][$i]; ?>"><?php echo $news['headlines'][$i]; ?></a></h3>
                                            <ul class="post-meta">
                                                <li><span class="icon fa fa-clock-o"></span><?php echo $news['cardDate'][$i]; ?></li>
                                            </ul>
                                            <div style="height: 180px;" class="text"><?php echo $news['contents'][$i]; ?></div>
                                        </div>
                                    </div>
                                </div>
