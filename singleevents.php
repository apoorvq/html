...
if (isset($_GET['event'])) 
{
    ...
    $singleEvent = getSingleEvent($event);
    //print_r($singleEvent);
    $relatedItems = getNews(10);
    $relatedEvents = getEvents();
            ...
            <div class="clearfix">
                ...
                <div class="pull-right">
                    <ul class="page-title-breadcrumb">
                        ...
                        <li><a href="#"><?php echo $singleEvent['event']; ?></a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="auto-container">
                ...
                <div class="row clearfix">
                    ...
                    <div class="image-column col-md-6 col-sm-12 col-xs-12">
                        <div class="carousel-outer">
                            <a href="#" class="lightbox-image" title="<?php echo $singleEvent['headlines']; ?>"><img width="570px" height="570px" src="<?php echo $singleEvent['source']; ?>" alt="<?php echo $singleEvent['headlines']; ?>"></a>
                        </div>
                    </div>
                    ...
                    <div class="info-column col-md-6 col-sm-12 col-xs-12">
                        <div class="inner-column">
                            <div class="details-header">
                                <h4><?php echo $singleEvent['event']; ?></h4>
                                <div class="item-price"><?php echo "From ".$singleEvent['dateStart']." to ".$singleEvent['dateEnd']; ?></div>
                            </div>
                            <div class="text">
                                <p><?php echo $singleEvent['details']; ?></p>
                            </div>
                            ...
                            <div class="other-options">
                                ...
                                <div style="margin-left: 0px" class="btns-box">
                                    <button type="button" class="theme-btn add-to-cart"><a href="<?php echo $singleEvent['link']; ?>"> Read More </a></button>
                                </div>
                            </div>

                            <ul class="tags-box">
                                <li>Categories: <a href="Categories.php?category=<?php echo $singleEvent['categoriesName']; ?>"><?php echo $singleEvent['categoriesName']; ?></a> </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="related-items">
                ...
                <div class="four-item-carousel owl-carousel owl-theme">
                    ...
                    <?php if ($relatedEvents['count']<=12) {
                        $count = $relatedEvents['count'];
                    }else{$count=12; echo $count;}
                     $count = $relatedEvents['count']<=12 ? $relatedEvents['count'] : 12; //echo $count;
                     for ($i=0; $i < $count ; $i++) {  ?>
                    <div class="shop-item">
                        <div class="inner-box">
                           
                            <div class="image-box">
                                <a href="singleEvent.php?news=<?php echo $relatedEvents['tag'][$i];?>"><img width="277px" height="333px" src="<?php echo $relatedEvents['source'][$i]; ?>" alt="" /></a>
                            </div>
                            <div class="lower-box">
                                 <a href="categories.php?category=<?php echo $relatedEvents['categoriesName'][$i];?>">
                                <div class="off-price" style="background-color: #222; top: -20%;border-radius: 0px;width: 70%"><?php echo $relatedEvents['categoriesName'][$i];?></div></a>
                                <div class="upper-box">
                                    <h4 style="height: 90px"><a href="singleEvent.php?news=<?php echo $relatedEvents['slugs'][$i];?>"><?php echo $relatedEvents['event'][$i]." in ".$relatedEvents['city'][$i].", ".$relatedEvents['country'][$i];?></a></h4>
                                </div>
                                <div class="lower-content">
                                    <div class="price"><?php echo "From ".$relatedEvents['dateStart'][$i]." to ".$relatedEvents['dateEnd'][$i] ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
